...
sns.boxplot(data=s4,x='Algorithm',y='States',ax=axs[0])
sns.boxplot(data=s8,x='Algorithm',y='States',ax=axs[1])
sns.boxplot(data=s10,x='Algorithm',y='States',ax=axs[2])
...
axs[0].set_xlabel("")
axs[0].set_title("4 queens")

axs[1].set_xlabel("")
axs[1].set_ylabel("")
axs[1].set_title("8 queens")
